          ...
          {/* GitHub Login Button */}
                        <div className="mt-6 pt-6 border-t border-white/10">
                                        ...
                                        <Button
                                                            ...
                                                            size="lg"
                                                            onClick={() => {
                                                                                  window.location.href = 'https://ep-curly-credit-acugheqo.neonauth.sa-east-1.aws.neon.tech/neondb/auth/signin/github?callbackUrl=' + encodeURIComponent(window.location.origin + '/dashboard')
                                                              }}
                                                          >
